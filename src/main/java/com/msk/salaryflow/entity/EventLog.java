...
public class EventLog {
    ...
    private String targetName; // Ім'я об'єкта (наприклад "John Doe")
    private Map<String, String> changeDetails;

    // Оновлений конструктор: додали String targetName
    public EventLog(String event, String entityName, String author, String targetId, String targetName) {
        ...
        this.targetName = targetName; // Тепер ми його зберігаємо
        this.timestamp = Instant.now();
    }

    // Другий конструктор теж приймає targetName
